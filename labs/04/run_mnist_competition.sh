...
# TODO "--cnn=CB-20-3-1-same,CB-20-3-1-same,F,R-300 --epochs  78 --batch_size 256"
# TODO "--cnn=CB-20-3-1-same,M-2-1,CB-20-3-1-same,F,R-300 --epochs  78 --batch_size 256"
# TODO "--cnn=CB-20-3-1-same,M-3-2,CB-20-3-1-same,F,R-300 --epochs  78 --batch_size 256"
# TODO "--cnn=CB-10-3-1-same,M-2-1,CB-10-3-1-same,M-2-1,CB-10-3-1-same,F,R-300 --epochs  78 --batch_size 256"
# TODO "--cnn=CB-10-3-1-same,CB-10-3-1-same,CB-10-3-1-same,F,R-300 --epochs  78 --batch_size 256"
# TODO "--cnn=CB-10-3-1-same,CB-10-3-1-same,CB-10-3-1-same,M-2-1,F,R-300 --epochs  78 --batch_size 256"
# TODO "--cnn=CB-10-3-1-same,CB-10-3-1-same,CB-10-3-1-same,M-3-2,F,R-300 --epochs  78 --batch_size 256"
)
